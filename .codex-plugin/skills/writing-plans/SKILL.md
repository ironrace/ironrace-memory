...
**Context:** Prefer a dedicated worktree when the repo and environment allow it. In Codex, follow the `using-git-worktrees` skill and the environment-detection guidance from `using-superpowers/references/codex-tools.md`.
...
- Fresh `spawn_agent(...)` worker per task + two-stage review
