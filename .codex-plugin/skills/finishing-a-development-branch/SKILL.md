...
When called from `subagent-driven-development`, this is the required next stage after the last approved task. Do not stop and hand control back before invoking it unless the work is blocked or the human explicitly redirects.
