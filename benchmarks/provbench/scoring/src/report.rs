...
use crate::metrics;
use crate::predictions::{PredictionRow, RunResult};
...
/// Score a completed Phase 0c LLM-baseline run directory, writing
/// `metrics.json` atomically.
pub fn score_llm_baseline_run(run_dir: &Path) -> Result<()> {
